...
# 全網通訊錄：填入節點的大名單
ALL_NODES = {
    "NODE_1":("100.114.193.3", 8001), 
    "NODE_2":("100.114.193.3", 8002),
    "NODE_3":("100.114.193.3", 8003),
    "NODE_4":("100.127.242.27", 8001),
    "NODE_5":("100.127.242.27", 8002),
    "NODE_6":("100.127.242.27", 8003),
    "NODE_7":("100.119.224.86", 8001),
    "NODE_8":("100.119.224.86", 8002),
    "NODE_9":("100.119.224.86", 8003)
}
